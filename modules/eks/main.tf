...
module "cluster_role" {
  ...
  assume_role_policy = file("${path.module}/iam_policies/cluster_assume_role_policy.json")
}
...
module "node_role" {
  ...
  assume_role_policy = file("${path.module}/iam_policies/node_assume_role_policy.json")
}
